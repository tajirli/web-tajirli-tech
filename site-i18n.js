    ...
    en: {
      ...
      pages: {
        home: {
          ...
          'nav.backendDocs': 'Backend Docs',
          'nav.ecoFrontendDocs': 'Eco AI Frontend',
          'nav.ecoBackendDocs': 'Eco AI Backend',
          'nav.architecture': 'Architecture',
          'nav.runbook': 'Runbook',
          'cta.startHere': 'Start Here',
          'hero.eyebrow': 'Unified Product Workspace',
          'hero.title': 'Find the right document in under 10 minutes.',
          'hero.lead': 'This hub is designed for beginners and cross-functional teams. It gives you a clear starting point, explains what each path is for, and helps you avoid wrong edits.',
          'hero.openMain': 'Open Main Docs',
          'hero.openApp': 'Open App Docs',
          'quick.title': 'Quick Start',
          'quick.step1': 'Choose one track first: website, app, backend, or Eco AI.',
          'quick.step2': 'Read architecture before changing code to avoid regressions.',
          'quick.step3': 'Use runbook and checklist before every release.',
          'quick.status': 'Routing and fallback pages are active and ready for public hosting.',
          'destinations.title': 'Choose Your Destination',
          'destinations.lead': 'Each card tells you what to open, when to open it, and what decisions it supports.',
          ...
          'card.backend.kicker': 'Backend',
          'card.backend.title': 'Backend Engineering Docs',
          'card.backend.desc': 'API families, backend architecture, and operational runbook for server flows.',
          'card.backend.link': 'Open Backend Docs',
          ...
          'card.ecoFrontend.kicker': 'Eco AI',
          'card.ecoFrontend.title': 'Eco AI Frontend Docs',
          'card.ecoFrontend.desc': 'React storefront, multilingual UI, and contact funnel documentation.',
          'card.ecoFrontend.link': 'Open Frontend Docs',
          'card.ecoBackend.kicker': 'Eco AI',
          'card.ecoBackend.title': 'Eco AI Backend Docs',
          'card.ecoBackend.desc': 'Express, MongoDB, and auth/contact API documentation.',
          'card.ecoBackend.link': 'Open Backend Docs',
          'workflow.title': 'Use This Workflow Order',
          'workflow.lead': 'Follow this sequence to move from discovery to execution with minimal confusion.',
          ...
          'why.title': 'Why this layout is easier to use',
          'why.b1': 'Clear hierarchy: the first action is always visible immediately.',
          'why.b2': 'Task-first labels: each section maps to real work, not abstract names.',
          'why.b3': 'Lower cognitive load: fewer choices per block and stronger visual grouping.',
          'why.b4': 'Consistent behavior across desktop and mobile for faster onboarding.',
    ...
    fr: {
      ...
      pages: {
        home: {
          ...
          'card.backend.kicker': 'Backend',
          'card.backend.title': 'Docs engineering backend',
          'card.backend.desc': 'Familles API, architecture backend et runbook operationnel des flux serveur.',
          'card.backend.link': 'Ouvrir docs backend',
          'card.ops.kicker': 'Operations',
          ...
          'card.ecoFrontend.kicker': 'Eco AI',
          'card.ecoFrontend.title': 'Docs Eco AI Frontend',
          'card.ecoFrontend.desc': 'Storefront React, interface multilingue et documentation du funnel contact.',
          'card.ecoFrontend.link': 'Ouvrir docs frontend',
          'card.ecoBackend.kicker': 'Eco AI',
          'card.ecoBackend.title': 'Docs Eco AI Backend',
          'card.ecoBackend.desc': 'Documentation Express, MongoDB et API auth/contact.',
          'card.ecoBackend.link': 'Ouvrir docs backend',
    ...
    ar: {
      ...
      pages: {
        home: {
          ...
          'nav.backendDocs': 'وثائق الباك اند',
          'nav.ecoFrontendDocs': 'Eco AI Frontend',
          'nav.ecoBackendDocs': 'Eco AI Backend',
          ...
          'card.backend.kicker': 'الباك اند',
          'card.backend.title': 'وثائق هندسة الباك اند',
          'card.backend.desc': 'عائلات API ومعمارية الخادم ودليل التشغيل لتدفقات السيرفر.',
          'card.backend.link': 'افتح وثائق الباك اند',
          ...
          'card.ecoFrontend.kicker': 'Eco AI',
          'card.ecoFrontend.title': 'وثائق Eco AI Frontend',
          'card.ecoFrontend.desc': 'متجر React والواجهة متعددة اللغات ووثائق مسار التواصل.',
          'card.ecoFrontend.link': 'افتح وثائق الواجهة',
          'card.ecoBackend.kicker': 'Eco AI',
          'card.ecoBackend.title': 'وثائق Eco AI Backend',
          'card.ecoBackend.desc': 'توثيق Express وMongoDB وواجهات auth/contact.',
          'card.ecoBackend.link': 'افتح وثائق الخادم',
